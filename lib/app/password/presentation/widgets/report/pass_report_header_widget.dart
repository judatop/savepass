...
import 'package:savepass/app/password/presentation/widgets/report/pass_report_search_widget.dart';

class PassReportHeaderWidget extends StatelessWidget {
  const PassReportHeaderWidget({super.key});
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            const Flexible(child: PassReportSearchWidget()),
          ],
        ),
      ],
    );
